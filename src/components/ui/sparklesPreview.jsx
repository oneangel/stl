...
export function SparklesPreview() {
  return (
    <div className="h-[40rem] pt-72 w-full bg-[#0f0f0f] flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="w-[40rem] h-40 relative">
        ...
        <div className="absolute inset-0 w-full bg-[#0f0f0f] h-full [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      </div>
    </div>
  );
}
